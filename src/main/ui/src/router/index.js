 ...
 * can be accessed by users have no rights at all
 */
...
/**
 * asyncRoutes
 * the routes that need to be dynamically loaded based on user rights
 */
// export const asyncRoutes = [
//     userRouter,
//     // 404 page must be placed at the end !!!
//     { path: '*', redirect: `${baseRoute}/404`, hidden: true }
// ];
